...
function Globe() {
  ...
  useEffect(() => {
    ...
    function onClick(e) {
      ...
      if (hits.length) {
        setSelectedInfo(hits[0].object.userData);
      } else {
      ...
      <div style={{ width: "100%", height: "100vh", position: "relative" }}>
        ...
        <div style={{
          ...
          <div>
            <label>
              <input type="checkbox"
                ...
                onChange={() => setShowEarthquakes(!showEarthquakes)}
              /> Earthquakes
            </label>
          </div>
          ...
          <div>
            <label>
              <input type="checkbox"
                ...
                onChange={() => setShowTornadoes(!showTornadoes)}
              /> Tornadoes
            </label>
          </div>
          ...
          <div>
            <label>
              <input type="checkbox"
                ...
                onChange={() => setShowHurricanes(!showHurricanes)}
              /> Hurricanes
            </label>
          </div>
          ...
          <div>
            <label>
              <input type="checkbox"
                ...
                onChange={() => setShowWildfires(!showWildfires)}
              /> Wildfires
            </label>
          </div>
          ...
          <div>
            <label>
              <input type="checkbox"
                checked={showPlanes}
                onChange={() => setShowPlanes(!showPlanes)}
              /> Planes
            </label>
          </div>
        ...
        {selectedInfo && (
          ...
          <div style={{
            ...
            {selectedInfo.time && <div>Time: {new Date(selectedInfo.time).toLocaleString()}</div>}
